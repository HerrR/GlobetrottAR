...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	[Tooltip("Background image for first screen")]
	public Sprite firstSprite;
	[Tooltip("Background image for second screen")]
    ...
    private void LerpToPage(int aPageIndex) {
        ...
        _currentPage = aPageIndex;
		if (_currentPage == 0) {
			//GameObject.Find ("Background").GetComponent<Image> ().sprite = firstSprite;
			GameObject.Find("backgroundDrake").GetComponent<Image>().CrossFadeAlpha(1, 0.3f, false);
		} else if (_currentPage == 1) {
			//GameObject.Find ("Background").GetComponent<Image> ().sprite = secondSprite;
			GameObject.Find("backgroundDrake").GetComponent<Image>().CrossFadeAlpha(0, 0.3f, false);
		}
    }
